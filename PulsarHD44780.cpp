...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{							 
		...
		_delay_us(50);														
		(data & 0b1000) ? D7PORT |= (1 << D7PIN) : D7PORT &=~ (1 << D7PIN);
		(data & 0b0100) ? D6PORT |= (1 << D6PIN) : D6PORT &=~ (1 << D6PIN);	
		(data & 0b0010) ? D5PORT |= (1 << D5PIN) : D5PORT &=~ (1 << D5PIN);
		(data & 0b0001) ? D4PORT |= (1 << D4PIN) : D4PORT &=~ (1 << D4PIN);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void sent_eight_bits(uint8_t data)      // This function sent eight bits, signal RW and signal E in the shift register.
	{
		SET_E_TO_1;							//Set E in 1 - transmission beginning.
		_delay_us(50);
		(data & 0b10000000) ? D7PORT |= (1 << D7PIN) : D7PORT &=~ (1 << D7PIN);
		(data & 0b01000000) ? D6PORT |= (1 << D6PIN) : D6PORT &=~ (1 << D6PIN);
		(data & 0b00100000) ? D5PORT |= (1 << D5PIN) : D5PORT &=~ (1 << D5PIN);
		(data & 0b00010000) ? D4PORT |= (1 << D4PIN) : D4PORT &=~ (1 << D4PIN);
		(data & 0b00001000) ? D3PORT |= (1 << D3PIN) : D3PORT &=~ (1 << D3PIN);
		(data & 0b00000100) ? D2PORT |= (1 << D2PIN) : D2PORT &=~ (1 << D2PIN);
		(data & 0b00000010) ? D1PORT |= (1 << D1PIN) : D1PORT &=~ (1 << D1PIN);
		(data & 0b00000001) ? D0PORT |= (1 << D0PIN) : D0PORT &=~ (1 << D0PIN);
		SET_E_TO_0;							 //Set E in 0 - transmission finishing.
		_delay_us(50);
	}
